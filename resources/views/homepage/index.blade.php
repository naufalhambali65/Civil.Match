            ...
            <div class="row justify-content-center pb-0 block__19738 section-counter">
                ...
                <div class="col-6 col-md-4 col-lg-3 mb-5 mb-lg-0">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                        <strong class="number" data-number="{{ $numberJobSeeker }}">0</strong>
                    </div>
                ...
                <div class="col-6 col-md-4 col-lg-3 mb-5 mb-lg-0">
                    <div class="d-flex align-items-center justify-content-center mb-2">
                        <strong class="number" data-number="{{ $numberPosts }}">0</strong>
                    </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img src="/homepage_assets/images/logo_mailchimp.svg" alt="Image" class="img-fluid logo-1">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img src="/homepage_assets/images/logo_paypal.svg" alt="Image" class="img-fluid logo-2">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img src="/homepage_assets/images/logo_stripe.svg" alt="Image" class="img-fluid logo-3">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img src="/homepage_assets/images/logo_visa.svg" alt="Image" class="img-fluid logo-4">
                </div>

                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img src="/homepage_assets/images/logo_apple.svg" alt="Image" class="img-fluid logo-5">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img src="/homepage_assets/images/logo_tinder.svg" alt="Image" class="img-fluid logo-6">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img src="/homepage_assets/images/logo_sony.svg" alt="Image" class="img-fluid logo-7">
                </div>
                <div class="col-6 col-lg-3 col-md-6 text-center">
                    <img src="/homepage_assets/images/logo_airbnb.svg" alt="Image" class="img-fluid logo-8">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="owl-carousel single-carousel">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-end text-center text-lg-right">
                        <img src="/homepage_assets/images/person_transparent_2.png" alt="Image"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 align-self-end text-center text-lg-right">
                        <img src="/homepage_assets/images/person_transparent.png" alt="Image" class="img-fluid mb-0">
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 ml-auto align-self-end">
                    <img src="/homepage_assets/images/apps.png" alt="Free Website Template by Free-Template.co"
                        class="img-fluid">
                </div>
            </div>
        </div>
